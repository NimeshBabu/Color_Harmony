...
export default function HarmonyCard({ title, subtitle, colors }: HarmonyCardProps) {
  ...
  return (
    <div className="relative overflow-hidden bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 flex flex-col w-full shadow-lg shadow-black/20 hover:shadow-2xl hover:shadow-black/40 hover:-translate-y-1 transition-all duration-300">

      {/* Header */}
      <div className="flex justify-between items-center mb-6 z-10">
        <div>
          <h3 className="text-white font-bold tracking-wide text-lg mb-1">
            {title}
          </h3>
      ...
      >
        ...
        <textarea
          className="w-full h-full flex-1 bg-black/40 border border-white/10 rounded-xl p-3 text-gray-200 text-sm resize-none focus:outline-none focus:ring-2 focus:ring-indigo-500/50 transition-all placeholder:text-gray-600 shadow-inner"
